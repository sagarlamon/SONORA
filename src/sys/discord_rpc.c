/**
 * @file discord_rpc.c
 * @brief Integration that shows sonora status in discord.
 *
...
void discord_rpc_clear(void)
{
        ...
        snprintf(payload, sizeof(payload),
                 "{\"cmd\":\"SET_ACTIVITY\",\"args\":{\"pid\":%d},\"nonce\":\"sonora_clear\"}",
                 getpid());
...
void notify_discord_update(SongData *song, time_t elapsed_seconds, time_t song_duration)
{
        ...
        snprintf(payload, sizeof(payload),
                 ...
                 "},"
                 "\"assets\":{"
                 "\"large_image\":\"sonora_logo\","
                 "\"large_text\":\"sonora music player\""
                 "}"
                 "}"
                 "},"
                 "\"nonce\":\"%s\""
