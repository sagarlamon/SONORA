...
static inline PixelData interpolate_pixel_color(PixelData a, PixelData b, float t)
{
        if (t <= 0.0f) return a;
        if (t >= 1.0f) return b;
        return (PixelData){
            .r = (unsigned char)(a.r + (int)((b.r - a.r) * t)),
            .g = (unsigned char)(a.g + (int)((b.g - a.g) * t)),
            .b = (unsigned char)(a.b + (int)((b.b - a.b) * t)),
            .a = 255
        };
}
